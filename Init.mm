...
void setTestSelection(int index)
{
    testSelection = index;
}
static void Resize(int32 w, int32 h)
{
	width = w;
	height = h;
    [[EINTAppDelegate getRootViewController] resizeWithWidth:w Height:h];
...
static void fireTimer()
{
    [[EINTAppDelegate getRootViewController] fireTimer];
}
void
Init::doInit()
{
	...
	TestEntry* e = g_testEntries;
     ...
     //- testList->add_item(testCount, e->name);
         [[EINTAppDelegate getRootViewController] addTestItemToList:[NSString stringWithUTF8String:e->name]];
         ++testCount;
         ++e;
     }
	...
	b2Vec2 lower = settings.viewCenter - extents;
	b2Vec2 upper = settings.viewCenter + extents;
    [[[EINTAppDelegate getRootViewController] graphicSceneView]setXScale:tw/(upper.x-lower.x)];
    [[[EINTAppDelegate getRootViewController] graphicSceneView]setYScale:th/(upper.y-lower.y)];
    [[[EINTAppDelegate getRootViewController] graphicSceneView]setXTranslate:tw/2];
    [[[EINTAppDelegate getRootViewController] graphicSceneView]setYTranslate:th/2];
    //fireTimer();
}
